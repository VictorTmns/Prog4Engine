...
static inline float  ImTrunc(float f)                                           { return static_cast<float>((int)(f)); }
static inline ImVec2 ImTrunc(const ImVec2& v)                                   { return ImVec2(static_cast<float>((int)(v.x)), static_cast<float>((int)(v.y))); }
static inline float  ImFloor(float f)                                           { return static_cast<float>((f >= 0 || (float)(int)f == f) ? (int)f : (int)f - 1); } // Decent replacement for floorf()
...
struct ImSpan
{
    ...
    inline int          size() const                { return (int)static_cast<ptrdiff_t>(DataEnd - Data); }
